    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Примеры работ, портфолио, окрашивание волос, тонирование волос, женские стрижки, сложное окрашивание" />
            ...
            <div className={styles.page}>
                ...
                <main className={styles.portfolio}>
                    ...
                    <>
                        <PortfolioCardList onCardClick={handleCardClick} arrayPortfolio={arrayPortfolio_2} type={'all'} />
                    </>
                    <Consultation />
                </main>
                <Footer />
