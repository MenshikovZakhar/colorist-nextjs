    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Примеры работ, портфолио, женские стрижки" />
            ...
            <div className={styles.page}>
                ...
                <main className={styles.portfolio}>
                    ...
                    <>
                        <PortfolioCardList onCardClick={handleCardClick} arrayPortfolio={arrayPortfolio_3} type={'all'} />
                    </>
                    <Consultation />
                </main>
                <Footer />
