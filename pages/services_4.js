    ...
    return (
        <>
            <Head>
                ...
                <title>Услуги</title>
                <meta name="description" content="Профессиональный уход за волосами, цены Челябинск" />
                    ...
                    <section className={styles.servicesme__description}>
                        <div className={styles.servicesme_description}>
                            <div className={styles.servicesme_title}>
                                <h2 className={styles.servicesme__title}>Профессиональный уход</h2>
                                <p className={styles.servicesme__text}>(стоимость зависит от категории подобранного ухода и расхода материала)</p>
                                <p className={styles.servicesme__text}>Входит: Мытьё головы, профессиональный уход,
                            ...
                            <div>
                                <div className={styles.price__box}>
                                    ...
                                    <div className={styles.servicesme__value}>

                                        <h3 className={styles.servicesme__title3}>Глубокое увлажнение</h3>
                                    </div>
                                    ...
                                    <span className={styles.servicesme_title_content}>
                                        ...
                                        <span className={styles.servicesme_price_content}><span className={styles.servicesme_price}> 1000 ₽<span className={styles.servicesme_point_zero}>
                                        </span></span> </span></span>
                                    <span className={styles.servicesme_title_content}>
                                ...
                                <div className={styles.price__box}>
                                    ...
                                    <div className={styles.servicesme__value}>
                                        ...
                                        <h3 className={styles.servicesme__title3}>Питание + белок</h3>
                                    </div>
                                ...
                                <div className={styles.price__box}>
                                    ...
                                    <div className={styles.servicesme__value}>
                                        ...
                                        <h3 className={styles.servicesme__title3}>Глоссинг (Glossing)</h3>
                                    </div>
