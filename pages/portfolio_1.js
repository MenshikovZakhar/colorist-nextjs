    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Примеры работ, Портфолио, сложное окрашивание" />
            ...
            <div className={styles.page}>
                ...
                <main className={styles.portfolio}>
                    ...
                    <>
                        <PortfolioCardList onCardClick={handleCardClick} arrayPortfolio={arrayPortfolio_1} type={'all'} />
                    </>
                    <Consultation />
                </main>
                <Footer />
