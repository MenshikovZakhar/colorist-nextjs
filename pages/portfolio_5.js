    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Примеры работ, портфолио, тонирование волос" />
            ...
            <div className={styles.page}>
                ...
                <main className={styles.portfolio}>
                    ...
                    <>
                        <PortfolioCardList onCardClick={handleCardClick} arrayPortfolio={arrayPortfolio_5} type={'all'} />
                    </>
                    <Consultation />
                </main>
                <Footer />
